...
class Prism_Clarrise_externalAccess_Functions(object):
	...
	def getAutobackPath(self, origin, tab):
		if platform.system() == "Windows":
			autobackpath = os.path.join(os.getenv('USERPROFILE'), "Documents", "Clarrise")
		else:
			if tab == "a":
